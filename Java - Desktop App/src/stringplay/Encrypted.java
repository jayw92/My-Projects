...
public class Encrypted {
    ...
    public Encrypted(String desc, int xy){
        a=desc;
        encrypted="";
        ...
        for (x=0;x<enc.size();x++){
            encrypted=encrypted+enc.get(x);
        }
        if (xy==1)
    ...
    /*public static void main(String args[]) {
        ...
        String code="";
        for (int y=0;y<96;y++){
            int a=gen.nextInt(92);
            int b=gen.nextInt(92);
            int c=gen.nextInt(92);
            int d=gen.nextInt(92);
            int e=gen.nextInt(92);
            int f=gen.nextInt(92);
            int g=gen.nextInt(92);
            int h=gen.nextInt(92);
            code="\""+alphanumerics[a]+alphanumerics[b]+alphanumerics[c]+alphanumerics[d]+alphanumerics[e]+alphanumerics[f]+alphanumerics[g]+alphanumerics[h]+"\",";
