...
public class StringPlayAboutBox extends javax.swing.JDialog {

    public StringPlayAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(stringplay.StringPlayApp.class).getContext().getResourceMap(StringPlayAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(stringplay.StringPlayApp.class).getContext().getActionMap(StringPlayAboutBox.class, this);
